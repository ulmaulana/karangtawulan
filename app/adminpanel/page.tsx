...
export default function LoginPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sea-foam/20 via-white to-sea-ocean/10">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-sea-ocean"></div>
      </div>
    }>
      <LoginForm />
    </Suspense>
